...
QString WriterBase::writeSlicerHeader(const QString& syntax) {
    ...
    rv += commentLine(QString("G-Code generated by ORNLSlicer ") % QString::fromUtf8(ORNL::BuildInfo::Version)) %
...
QString WriterBase::writeSettingsHeader(GcodeSyntax syntax) {
    ...
    if (syntax == GcodeSyntax::kJuggerBot || syntax == GcodeSyntax::kMarlin || syntax == GcodeSyntax::kGudel ||
        syntax == GcodeSyntax::kDmgDmu || syntax == GcodeSyntax::kHaasMetric || syntax == GcodeSyntax::kHurco ||
