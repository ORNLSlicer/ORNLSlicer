...
const QString Constants::ProfileSettings::Inset::kBranchAfterTipWipe = "spiral_inset_branch_after_tip_wipe";
...
// Radial
const QString Constants::ProfileSettings::Radial::kRadialPathBoundaryPolicy = "radial_path_boundary_policy";
